      ...
      <div className="space-y-6">
        <div className="prose dark:prose-invert max-w-none">
          ...
          <blockquote className="mt-2 text-gray-600 dark:text-gray-300 border-l-4 border-blue-500 pl-4">
            "Exploring the latest developments in #AI: Recent breakthroughs in large language models demonstrate 
            significant improvements in natural language understanding. Key findings suggest 30% enhanced 
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
          <Form method="post" onSubmit={handleSubmit} className="space-y-8">
            ...
            <ToneSelector
              ...
              onChange={(tone) => setFormState(prev => ({
                ...prev,
                tone
              }))}
            />
          ...
          <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Discover how our AI-powered content generator can help you create engaging
        ...
        {actionData?.error && (
          <div className="mt-6 p-4 bg-red-50 dark:bg-red-900/20 text-red-600 
